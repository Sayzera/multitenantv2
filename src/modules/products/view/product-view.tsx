      ...
      <div className="border rounded-sm bg-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6">
          <div className="col-span-4">
            ...
            <div className="p-6">
              {data.description ? (
                <p className="p-6">{data.description}</p>
              ) : (
            ...
            <div className="border-t lg:border-t-0 lg:border-l h-full">
              <div className="flex flex-col gap-4 p-6 border-b">
                ...
                <div className="text-center font-medium">
                  {data.refundPolicy.name === 'no-refunds'
                    ? 'No refunds'
                    : `${data.refundPolicy.name} money back guarantee`}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-[auto_1fr_auto] gap-3 mt-3">
                  {[5, 4, 3, 2, 1].map((stars) => (
                    <Fragment key={stars}>
                      <div className="font-medium">{stars === 1 ? 'star' : 'stars'}</div>
